 ...
 * @param {Array<[flectionIdKey: UtilTypes.TGetUuidKeys, text_de: string, text_sv: string]>} listOfFlectionIdKeyWithTextTuple
 * @return {Types.ITranslation[]}
 */
